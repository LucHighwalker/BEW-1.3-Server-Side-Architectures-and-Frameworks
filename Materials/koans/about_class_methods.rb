...
class AboutClassMethods < Neo::Koan
  ...
  # I prefer the second way, as self can be replaced with other variables allowing
  # the code to be more abstract. Though the first one would be useful if you want
  # immutable methods.
